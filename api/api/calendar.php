...
class Lunar
{
     ...
     * 将阴历转换为阳历
     * @param int $year 阴历-年
     * @param int $month 阴历-月，闰月处理：例如如果当年闰五月，那么第二个五月就传六月
     * @param int $date 阴历-日
     * @return array
     */
    function convertLunarToSolar($year, $month, $date)
    {
        ...
        $day = explode('-', $res);
        return array($day[0], $day[1], $day[2]);
    }
     ...
     * @return string
     */
    function getCapitalNum($num, $isMonth = false)
    {
    ...
    function getFestival($today, $nl_info = false, $config = 1)
    {
        if ($config == 1) {
            $arr_lunar = array(
                '01-01' => '春节', '01-15' => '元宵节', '02-02' => '二月二', '05-05' => '端午节',
                '07-07' => '七夕节', '08-15' => '中秋节', '09-09' => '重阳节', '12-08' => '腊八节', '12-23' => '小年'
            );
            $arr_solar = array(
                '01-01' => '元旦', '02-14' => '情人节', '03-12' => '植树节', '04-01' => '愚人节',
                '05-01' => '劳动节', '06-01' => '儿童节', '10-01' => '国庆节', '10-31' => '万圣节',
                '12-24' => '平安夜', '12-25' => '圣诞节'
            );
        }
        $festivals = array();
        ...
        if (isset($arr_lunar[$md_lunar])) {
            array_push($festivals, $arr_lunar[$md_lunar]);
        }
        if (isset($arr_solar[$md_solar])) {
            array_push($festivals, $arr_solar[$md_solar]);
        }
        ...
        if ($jieqi) {
            array_push($festivals, $jieqi['name1']);
        }
...
{
    $xiaoshi = date("H");
    if ($xiaoshi >= 0 && $xiaoshi < 6) {
        return "凌晨";
    } elseif ($xiaoshi >= 6 && $xiaoshi < 9) {
        return "早上";
    } elseif ($xiaoshi >= 9 && $xiaoshi < 11) {
        return "上午";
    } elseif ($xiaoshi >= 11 && $xiaoshi < 13) {
        return "中午";
    } elseif ($xiaoshi >= 13 && $xiaoshi < 18) {
        return "下午";
    } elseif ($xiaoshi >= 18 && $xiaoshi < 24) {
        return "晚上";
    }
}
...
$lunar = new Lunar();
$shichen = array(
    '23' => '子时', '00' => '子时', '01' => '丑时', '02' => '丑时',
    '03' => '寅时', '04' => '寅时', '05' => '卯时', '06' => '卯时',
    '07' => '辰时', '08' => '辰时', '09' => '巳时', '10' => '巳时',
    '11' => '午时', '12' => '午时', '13' => '未时', '14' => '未时',
    '15' => '申时', '16' => '申时', '17' => '酉时', '18' => '酉时',
    '19' => '戌时', '20' => '戌时', '21' => '亥时', '22' => '亥时'
)[date("H")];
$today = $lunar->convertSolarToLunar(date("Y"), date("m"), date("d")); //获取当前农历
$month = $lunar->getJieQi(date("Y"), date("m"), date("d")); //获取当前节气
$array = array(
    "日期" => date("Y年m月d日") . " " . getWeek(),
    "农历" => $today[3] . $today[6] . "年 " . $today[1] . $today[2],
    "时间" => date("H:i:s") . " " . getStrTime(),
    "时辰" => $shichen,
    "节气" => $month["name2"]
);
